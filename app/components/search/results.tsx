  ...
  return (
    <Fragment>
      ...
      <Show when={!!query && hits.length >= 1}>
        {hits.map((hit) => {
          return <Hit query={query} hit={hit} key={hit.objectID} />
        })}
      </Show>
              ...
              return (
                <li
                  ...
                  <button
                    ...
                    aria-label='Click to delete this query'
                    className='w-6 h-6 mr-[.18rem] flex items-center justify-center rounded-full border border-gray-300 cursor-pointer'>

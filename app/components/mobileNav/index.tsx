...
export const MobileNav = () => {
  ...
  return (
      <Show when={!!state.active}>
        <div className='backdrop-blur-md fixed left-0 top-0 w-full h-screen z-10 bg-ash/30 md:hidden' onClick={handleNavClose}>
          <nav className={classes}>
            ...
            <ul className='p-0 mt-14'>
              {
                ['Explore', 'Contact', 'Series', 'Donate'].map((link) => {
